...
/** Token-driven Select compound — wraps Radix Select. */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between gap-2 rounded-md px-3 py-2 text-sm',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'data-[highlighted]:bg-[var(--color-bg-surface-alt)] data-[highlighted]:text-[var(--color-text-default)]',
