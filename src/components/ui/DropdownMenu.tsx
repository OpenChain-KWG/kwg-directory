...
/** Token-driven DropdownMenu compound — wraps Radix DropdownMenu. */
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'focus:bg-[var(--color-bg-surface-alt)]',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-popover min-w-32 overflow-hidden rounded-md p-1',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'transition-colors duration-150 ease-out',
      'focus:bg-[var(--color-bg-surface-alt)] focus:text-[var(--color-text-default)]',
