...
export default function ProfileNewError({ error, reset }: ErrorProps) {
  const t = useTranslations('errorPage')

  useEffect(() => {
    logger.error(
      { event: 'app_error', route: 'profile_new', digest: error.digest },
      'profile new route error',
    )
  }, [error])
